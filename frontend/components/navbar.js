            ...
            <ul class="navbar-nav">
               ...
               <li class="nav-item">
                  <div className={styles.dropdown}>
                     <span>
                        <a class="nav-link active">คำสั่งซื้อ</a>
                     </span>
                     <div className={styles.content}>
                        <p><a class="nav-link active btn btn-sm btn-outline-secondary" href="/delivery">วิธีการจัดส่ง</a></p>
                        <p><a class="nav-link active btn btn-sm btn-outline-secondary" href="/order">สถานที่จัดส่ง</a></p>
                        <p><a class="nav-link active btn btn-sm btn-outline-secondary" href="/Transfermoney">การชำระเงิน</a></p>
